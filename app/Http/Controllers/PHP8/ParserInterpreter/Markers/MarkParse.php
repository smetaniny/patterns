...
namespace App\Http\Controllers\PHP8\ParserInterpreter\Markers;


use App\Http\Controllers\PHP8\ParserInterpreter\Context\Context;
use App\Http\Controllers\PHP8\ParserInterpreter\Context\InterpreterContext;
use App\Http\Controllers\PHP8\ParserInterpreter\Expressions\Expression;
use App\Http\Controllers\PHP8\ParserInterpreter\Expressions\VariableExpression;
use App\Http\Controllers\PHP8\ParserInterpreter\Handlers\BooleanAndHandler;
use App\Http\Controllers\PHP8\ParserInterpreter\Handlers\BooleanOrHandler;
use App\Http\Controllers\PHP8\ParserInterpreter\Handlers\EqualsHandler;
use App\Http\Controllers\PHP8\ParserInterpreter\Handlers\StringLiteralHandler;
use App\Http\Controllers\PHP8\ParserInterpreter\Handlers\VariableHandler;
use App\Http\Controllers\PHP8\ParserInterpreter\Parsers\AlternationParse;
use App\Http\Controllers\PHP8\ParserInterpreter\Parsers\CharacterParse;
use App\Http\Controllers\PHP8\ParserInterpreter\Parsers\Parser;
use App\Http\Controllers\PHP8\ParserInterpreter\Parsers\RepetitionParse;
use App\Http\Controllers\PHP8\ParserInterpreter\Parsers\SequenceParse;
use App\Http\Controllers\PHP8\ParserInterpreter\Parsers\StringLiteralParse;
use App\Http\Controllers\PHP8\ParserInterpreter\Parsers\WordParse;
use App\Http\Controllers\PHP8\ParserInterpreter\Readers\StringReader;
...
class MarkParse
{
     ...
     */
    #[NoReturn] public function compile(string $statementStr): void
    {
